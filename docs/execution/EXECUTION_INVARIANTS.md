...
50. `EXE-INV-050` — Settlement cria cinco direitos 30/20/20/20/10. Financial Platform materializa créditos; Withdrawal é o único fluxo que instrui saída ao Asaas (`DEC-001/004`).
