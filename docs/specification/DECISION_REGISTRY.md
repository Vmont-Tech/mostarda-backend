...
| `DEC-063` | Telemetry Context é o owner exclusivo das accepted observations imutáveis, do Telemetry Ledger append-only e de AudienceProjection; a projeção é interna a Telemetry, somente novos quotes podem consumi-la e Telemetry/Audience nunca materializam Evidence | Edge Telemetry Architecture + Platform Specification | ACCEPTED |
