...
| `SPEC-MEDIA-001..004` | `domain/PLAYER.md`, `CANVAS.md`, `AGGREGATES.md`; `execution/STATE_MACHINES.md` | ADR-002 |
...
As decisões `OPEN-001..010` da especificação não têm artefato derivado definitivo. Quando fechadas, esta matriz deve listar os documentos e ADRs impactados antes de qualquer implementação.
